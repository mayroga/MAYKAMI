...
async function escribir(texto,color="#fff",forzarVisual=false){
    ...
    await new Promise(r=>setTimeout(r,1500)); // mantener lectura
}
...
async function mostrarBloque(b){
    ...
    // Mostrar botones solo cuando se necesiten
...
startBtn.onclick = async ()=>{
    ...
    // mostrar panel inicial 5 segundos
    startBtn.style.display="none";
    await new Promise(r=>setTimeout(r,5000));

    appPanel.style.display="flex"; // oculto mientras no se necesite

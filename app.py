...
def obtener_info_tiempo():
    ...
    # Cobro inicia 10 min antes (8:50 a 9:15) y (20:50 a 21:15)
...
async def acceso_admin(es_admin: bool = Depends(autenticar_admin)):
    """Redirección directa del servidor al servicio con bypass de pago."""
...
async def create_checkout_session():
    ...
    if not turno:
        return JSONResponse({"error": "La taquilla abre a las 8:50 AM/PM (10 min antes de la sesión)."}, status_code=403)
